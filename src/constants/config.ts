...
export const SITE_CONFIG = {
  seo: {
    title: 'BRIGHT | DESIGN & WEB - その想い、伝わるカタチに。',
    description: 'ブランディングからWeb制作・集客まで、成果につながるデザインで、あなたのビジネスの未来をつくります。',
    url: 'https://bright-design-web.vercel.app',
  },
  contact: {
    phone: '',
    ...
    items: [
      {
        ...
        blobPath: '/images/blob_01.png', // Background blob
        color: '#76c8bb'
      },
      {
        id: 'web-design',
    ...
    items: [
      {
        ...
        imagePath: '/images/work_01.jpg', // Placeholders for now
        blobPath: '/images/blob_05.png'
      },
      {
        id: 'work2',
        ...
        imagePath: '/images/work_02.jpg',
        blobPath: '/images/blob_06.png'
      },
      {
        id: 'work3',
        name: 'みなみクリニック',
        ...
        imagePath: '/images/work_03.jpg',
        blobPath: '/images/blob_07.png'
      },
      {
        id: 'work4',
        name: 'ひかり整骨院',
